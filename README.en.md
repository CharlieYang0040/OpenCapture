...
The project is an actively developed technical prototype. It can capture a window, monitor, or region with Windows Graphics Capture, crop and scale on D3D11, and produce H.264/AAC MKV recordings or PNG/clipboard still captures. GIF, recovery actions, and MP4 remux are still under development.
...
- Incomplete-MKV recovery actions and recording pause
