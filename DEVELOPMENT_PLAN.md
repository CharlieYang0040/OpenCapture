...
2026-07-24 점검 기준으로 GPU H.264/AAC MKV 녹화, 스크린샷, 클립보드 캡처와 안전 임시 저장이 실제 UI에 연결되었다. GIF, 복구 실행, MP4 remux 및 장시간 성능 검증은 아직 남아 있다.
...
- `.part.mkv` 안전 저장, 시작 전 공간 검사 및 미완료 파일 검색
