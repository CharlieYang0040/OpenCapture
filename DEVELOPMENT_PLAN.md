...
2026-07-24 점검 기준으로 GPU H.264/AAC MKV 녹화, 스크린샷, 클립보드 캡처, 안전 임시 저장, 미완료 MKV 복구, 일시정지 및 MP4 remux가 실제 UI에 연결되었다. GIF와 장시간 성능 검증은 아직 남아 있다.
...
4. 임시 MKV, 저장 공간 검사, 일시정지, 복구 및 MP4 remux를 구현한다. (핵심 기능 및 스모크 완료)
