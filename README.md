...
현재는 활발히 개발 중인 기술 시제품 단계입니다. 창·모니터·영역을 Windows Graphics Capture로 받아 D3D11에서 자르기와 크기 조절을 수행하고, H.264/AAC MKV 녹화 또는 PNG·클립보드 캡처로 출력할 수 있습니다. GIF, 복구 실행 및 MP4 remux는 아직 개발 중입니다.
...
- 결과를 명확히 구분한 클립보드·PNG·비디오 버튼과 미구현 GIF 비활성 표시
