...
최신 기술 프리뷰는 [OpenCapture v0.2.0](https://github.com/CharlieYang0040/OpenCapture/releases/tag/v0.2.0)이며,
상세 변경 및 검증 범위는 [v0.2.0 릴리스 노트](docs/releases/v0.2.0.md)에 기록합니다.
...
GitHub Releases에서 `OpenCapture-0.2.0-windows-x64.zip`과 `SHA256SUMS.txt`를 받은 뒤
...
`OpenCapture-0.2.0-ffmpeg-build-materials.zip`에 함께 제공합니다.
