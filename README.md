...
현재는 활발히 개발 중인 기술 시제품 단계입니다. 창·모니터·영역을 Windows Graphics Capture로 받아 D3D11에서 자르기와 크기 조절을 수행하고, H.264/AAC MKV·MP4 또는 PNG·클립보드 캡처로 출력할 수 있습니다. GIF는 아직 개발 중입니다.
